...
export class Armory {
    ...
    public async start(): Promise<void> {
        ...
        app.use("/data/backgrounds", express.static("data/backgrounds"));
        ...
        app.get("/character/:realm/:name/account", this.wrapRoute(charsController.account.bind(charsController)));
